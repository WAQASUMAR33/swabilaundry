...
const FilterableTable = () => {
  ...
  const handleNameChange = (e) => {
    ...
    const slug = name.toLowerCase().replace(/\s+/g, '-'); // Convert to lowercase and replace spaces with hyphens
    setNewCategory((prev) => ({
      ...prev,
      name,
  ...
  const handleAddNewItem = async () => {
    ...
    try {
      ...
      if (image) {
        ...
        console.log("The Data URL is: " + result.image_url);
        if (response.ok) {
      ...
      <div className="bg-white shadow rounded-lg p-4 relative">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
           ...
           src={`${process.env.NEXT_PUBLIC_UPLOADED_IMAGE_URL}/${item.imageUrl}`} alt={item.name} className="w-16 h-16 object-cover" />}
                    </td>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-4 w-[700px] rounded shadow-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-4">
              ...
              onChange={handleNameChange} // Use the function here
              className="p-2 border border-gray-300 rounded w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            </div>
              ...
              <div className="mb-4">
                ...
                <Image
                 width={1000}
                  height={1000}
                  placeholder="data:image/jpeg;base64,"
           src={`https://murshadpkdata.advanceaitool.com/${newCategory.imageUrl}`} alt={newCategory.name} className="w-32 h-32 object-cover mb-2" />
              </div>
            )}
            <div className="mb-4">
