...
const FAQSection = ({ imageSrc }) => {
  ...
  const faqs = [
    { 
      question: 'What is Swabi Laundry.com?', 
      answer: 'Swabi Laundry is the one-stop online shopping portal of coupons, promo code and discount offers for online shopping in different verticals such as fashion, electronics and home decor amongst many others. At Swabi Laundry.com, we help you in saving money on your favorite brands and products.' 
    },
    { 
      question: 'How do I use a promo code from Swabi Laundry?', 
      answer: 'Using a Promo Codes from Swabi Laundry is as easy as 1-2-3. Find your code, click to reveal, and copy. Then, on the checkout on retailer\'s website paste your code for instantly applying your discount.' 
    },
    { 
    ...
    { 
      question: 'Does Swabi Laundry offer exclusive discounts?', 
      answer: 'Yes, Swabi Laundry provides exclusive discounts and voucher codes not found on any other platform. That is because we keep partnering with leading brands for the best possible offers, so you need to visit our site quite often.' 
    },
  ];
        ...
        <div className="flex md:flex-row flex-col justify-center h-auto md:h-full">
          <div className="md:w-[400px] md:h-[400px] w-full h-full">
            <Image
              ...
              src="/footer/Swabi Laundry.png" // Replace with the correct path to your image
          ...
          <div className="w-full md:w-1/2 text-black text-center md:text-left p-4 mt-4">
                <h1 className="text-4xl md:text-3xl font-bold mb-4">
                  Get Unlimited Coupons <span className="text-black">#Swabi Laundry</span>
                </h1>
                <p className="text-lg md:text-lg mb-6">
                  Make Your Laundry Experience Marvelous with Swabi Laundry
                </p>
