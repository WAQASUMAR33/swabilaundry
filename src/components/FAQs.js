...
export default function FAQ() {
  const faqs = [
    {
      question: "How does  help brands build personal relationships with their customers?",
      answer:
    ...
    {
      question: "What sets  apart from other digital agencies?",
      answer:
    ...
    {
      question: "Can you provide examples of successful projects Swabi Laundry has completed?",
      answer:
    ...
    {
      question: "How does Swabi Laundry ensure the security and scalability of its web solutions?",
      answer:
    ...
    {
      question: "What is Swabi Laundry's approach to pricing and project timelines?",
      answer:
    ...
    {
      question: "How can I get started with Swabi Laundry on my next digital project?",
      answer:
